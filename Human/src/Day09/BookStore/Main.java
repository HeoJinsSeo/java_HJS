...
public class Main {
	...
	public static void main(String[] args) {
       ...
       String[][] bookList = new String[BOOK_COUNT][BOOK_ITEM];
		...
		Person person = new Person(userName, tel);  //고객 정보 객체
	...
	public static void showMenu() {
		...
		String welcome = "휴먼서점에 오신 걸 환영합니다.";
	...
	public static void cartAdd(String[][] bookList) {
        ...
        // 장바구니에 지정된 도서항목을 추가
	     boolean end = false;
	     while(!end) {
	    	 System.out.print("장바구니에 추가할 도서 정보 입력 : ");
	         Scanner sc = new Scanner(System.in);
	...
	private static int getCartIndex(String bookId) {
	...
	public static void cartSetCount() {
		...
		Scanner sc = new Scanner(System.in);
	    System.out.print("수량을 조절할 장바구니번호 : ");
	    int no = sc.nextInt();
 ...
 */
   ...
   // 장바구니의 상품 목록 확인
	...
	public static int getCartIndex1 (String bookId) {
